...
public class NavController implements Initializable {
    ...
    public void generalButtons(){
        ...
        /**Floor onactions**/
        floorGB.setOnAction(e -> { imageView.setImage(campusMap); });
        floor1B.setOnAction(e -> { imageView.setImage(floor1Map); });
        floor2B.setOnAction(e -> { imageView.setImage(floor2Map); });
        floor3B.setOnAction(e -> { imageView.setImage(floor3Map); });
        floor4B.setOnAction(e -> { imageView.setImage(floor4Map); });
        floor5B.setOnAction(e -> { imageView.setImage(floor5Map); });
