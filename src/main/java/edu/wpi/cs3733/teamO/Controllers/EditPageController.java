...
public class EditPageController implements Initializable {
  ...
  //TODO is this still true/needed? does it actually do this?
  ...
  // will be replaced by PopupMaker.incompletePopup(warningPane)
  ...
  // will be replaced by PopupMaker.nonexistentPopup(warningPane);
