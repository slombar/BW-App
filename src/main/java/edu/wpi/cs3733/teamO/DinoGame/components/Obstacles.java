...
public class Obstacles {
  ...
  public Obstacles(int firstPos) {
    ...
    imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-1.png"));
    imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-2.png"));
    imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-2.png"));
    imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-1.png"));
    // imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-3.png"));
    // imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-4.png"));
    imageList.add(new Resource().getResourceImage("/DinoImages/Cactus-5.png"));
