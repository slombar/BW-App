...
public class Dino {
  ...
  public Dino() {
    image = new Resource().getResourceImage("/DinoImages/Dino-stand.png");
    leftFootDino = new Resource().getResourceImage("/DinoImages/Dino-left-up.png");
    rightFootDino = new Resource().getResourceImage("/DinoImages/Dino-right-up.png");
    deadDino = new Resource().getResourceImage("/DinoImages/Dino-big-eyes.png");
